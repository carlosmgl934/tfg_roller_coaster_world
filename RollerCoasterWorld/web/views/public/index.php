    ...
    <?php if ($is_logged): ?>
        ...
        <div class="home-hero" id="home-hero-carousel">
            ...
            <div class="home-hero-slide active" data-default-img=""
                ...
                data-sub="Bienvenido de nuevo a la comunidad de amantes de las montañas rusas. Sigue explorando y aumentando tus credits."
            ...
            <div class="home-hero-content" id="home-hero-content">
                <div class="home-hero-tag animate d1" id="hero-tag">
                    ...
                    <span id="hero-tag-text" data-i18n="home.personal_panel">Tu Panel Personal</span>
                </div>
                <h1 class="home-hero-title animate d2" id="hero-title">
                    <span data-i18n="home.welcome">Bienvenido,</span><br>
                    <span style="color:var(--rcw-green)" id="hero-username">…</span>
                </h1>
                <p class="home-hero-sub animate d3" id="hero-sub" data-i18n="home.welcome_back">Bienvenido de nuevo a la
                    comunidad de amantes de las
        ...
        <div class="home-stats-bar">
            <div class="home-stat-item">
                ...
                <div class="home-stat-label" data-i18n="home.stats_users">Usuarios</div>
            </div>
            <div class="home-stat-divider"></div>
            <div class="home-stat-item">
                <div class="home-stat-num" id="cnt-coasters">—</div>
                <div class="home-stat-label" data-i18n="home.stats_coasters">Coasters</div>
            </div>
            <div class="home-stat-divider"></div>
            <div class="home-stat-item">
                <div class="home-stat-num" id="cnt-reviews">—</div>
                <div class="home-stat-label" data-i18n="home.stats_reviews">Reseñas</div>
            </div>
            <div class="home-stat-divider"></div>
            <div class="home-stat-item">
                <div class="home-stat-num" id="cnt-photos">—</div>
                <div class="home-stat-label" data-i18n="home.stats_photos">Fotos</div>
            </div>
            <div class="home-stat-divider"></div>
            <div class="home-stat-item">
                <div class="home-stat-num" id="cnt-parks">—</div>
                <div class="home-stat-label" data-i18n="home.stats_parks">Parques</div>
            </div>
        </div>
        ...
        <div class="home-wrapper">
            ...
            <div class="home-section">
                <div class="home-section-title" data-i18n="home.explore">Explorar</div>
                <div class="home-section-sub" data-i18n="home.explore_sub">Todo lo que necesitas a un clic de distancia
                </div>
                <div class="home-qlink-grid">
                    <a href="<?= Router::url('coaster_search') ?>" class="home-qlink">
                        ...
                        <div class="home-qlink-name" data-i18n="home.search_coasters">Buscar Coasters</div>
                        <div class="home-qlink-desc" data-i18n="home.search_coasters_desc">Explora miles de montañas rusas
                            con nuestros filtros avanzados</div>
                    </a>
                    <a href="<?= Router::url('ranking') ?>" class="home-qlink">
                        <i class="fa-solid fa-list-ol home-qlink-icon"></i>
                        <div class="home-qlink-name" data-i18n="home.global_tops">Tops Globales</div>
                        <div class="home-qlink-desc" data-i18n="home.global_tops_desc">Descubre las mejores coasters
                            valoradas por nuestra comunidad</div>
                    </a>
                    <a href="<?= Router::url('forums') ?>" class="home-qlink">
                        <i class="fa-solid fa-comments home-qlink-icon"></i>
                        <div class="home-qlink-name" data-i18n="home.forums">Foros</div>
                        <div class="home-qlink-desc" data-i18n="home.forums_desc">Unéte a debates, entérate de noticias y
                            novedades</div>
                    </a>
                    <a href="<?= Router::url('trips') ?>" class="home-qlink">
                        <i class="fa-solid fa-route home-qlink-icon"></i>
                        <div class="home-qlink-name" data-i18n="home.my_trips">Mis Viajes</div>
                        <div class="home-qlink-desc" data-i18n="home.my_trips_desc">Planifica y comparte tus rutas a
                            diferentes parques</div>
                    </a>
                </div>
            </div>
            ...
            <div class="home-section rcw-recs-section" id="recs-section">
                ...
                <div class="rcw-recs-header">
                    <div class="rcw-recs-title-group">
                        <div class="home-section-title" style="margin-bottom:0;" data-i18n="home.for_you">Especialmente para
                            ti</div>
                    </div>
                    <div class="d-flex align-items-center gap-2">
                        <span class="text-muted small d-none d-sm-inline" data-i18n="home.based_on_profile">
                        ...
                        <button class="rcw-recs-refresh-btn" id="recs-refresh-btn" title="Actualizar recomendaciones">
                            ...
                            <span class="d-none d-sm-inline" data-i18n="home.refresh">Actualizar</span>
                        </button>
                    </div>
                </div>
            ...
            <div class="home-section" style="padding-top:0;">
                <div class="row g-4">
                    ...
                    <div class="col-12 col-lg-4 d-flex flex-column">
                        <div class="home-section-title" style="margin-bottom:1.2rem;" data-i18n="home.your_profile">Tu
                            Perfil</div>
                        <div class="home-profile-mini flex-grow-1">
                            ...
                            <div class="home-profile-mini-stats">
                                <div class="home-profile-mini-stat">
                                    ...
                                    <div class="home-profile-mini-stat-label" data-i18n="home.coaster_count">Coaster Count
                                    </div>
                                </div>
                                <div class="home-profile-mini-stat">
                                    <div class="home-profile-mini-stat-num" id="stat-reviews">0</div>
                                    <div class="home-profile-mini-stat-label" data-i18n="home.reviews">Reseñas</div>
                                </div>
                                <div class="home-profile-mini-stat">
                                    <div class="home-profile-mini-stat-num" id="stat-parks">0</div>
                                    <div class="home-profile-mini-stat-label" data-i18n="home.parks">Parques</div>
                                </div>
                                <div class="home-profile-mini-stat" style="border-bottom:none;">
                                    <div class="home-profile-mini-stat-num" id="stat-trips">0</div>
                                    <div class="home-profile-mini-stat-label" data-i18n="home.trips">Viajes</div>
                                </div>
                                <div class="home-profile-mini-stat" style="border-bottom:none;">
                                    <div class="home-profile-mini-stat-num" id="stat-friends">0</div>
                                    <div class="home-profile-mini-stat-label" data-i18n="home.friends">Amigos</div>
                                </div>
                                <div class="home-profile-mini-stat" style="border-bottom:none;">
                                    <div class="home-profile-mini-stat-num" id="stat-photos">0</div>
                                    <div class="home-profile-mini-stat-label" data-i18n="home.photos">Fotos</div>
                                </div>
                            </div>
                            <div class="home-favorite-coaster">
                                <i class="fa-solid fa-star" style="color:var(--rcw-green);"></i>
                                <span><span data-i18n="home.favorite">Favorita:</span> <strong class="text-truncate ms-1"
                                        id="fav-coaster"
                            ...
                            <div class="home-profile-mini-footer flex-column" style="gap: 0.5rem; padding: 1rem 1.2rem;">
                                <a href="<?= Router::url('profile') ?>#tops"
                                    ...
                                    <i class="fa-solid fa-ranking-star me-2"></i> <span data-i18n="home.my_tops">Mis
                                        Tops</span>
                                </a>
                                <div class="d-flex w-100" style="gap: 0.5rem;">
                                    <a href="<?= Router::url('profile') ?>" class="home-btn-mini flex-fill"><i
                                            ...
                                            data-i18n="home.profile">Perfil</span></a>
                                    <a href="<?= Router::url('profile') ?>#config" class="home-btn-mini flex-fill"><i
                                            class="fa-solid fa-gear me-2"></i><span
                                            data-i18n="home.config">Config</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-8 d-flex flex-column">
                        <div class="home-section-title" style="margin-bottom:1.2rem;" data-i18n="home.latest_news">Últimas
                            Novedades</div>
                ...
                <div class="modal-content text-start border-0 rounded-0 shadow-lg"
                    ...
                    <div class="modal-footer border-0 px-4 pb-4 pt-0" style="background:#161b22;">
                        <button type="button" class="btn btn-outline-secondary rounded-0 px-4" data-bs-dismiss="modal"
                            data-i18n="common.close">Cerrar</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php else: ?>
        ...
        ">
            <div class="container text-center py-5">
                <span class="landing-badge mb-4 d-inline-block">
                    <i class="fa-solid fa-circle-dot me-1 text-success"></i> <span data-i18n="home.community_badge">La
                        comunidad de coaster enthusiasts</span>
                </span>
                <h1 class="display-2 fw-bold mb-3 landing-title text-white"><span data-i18n="home.discover">Descubre tu
                        próxima</span> <span class="text-neon d-block" data-i18n="home.adventure">aventura</span></h1>
                <p class="lead mb-5 mx-auto text-light" style="max-width: 640px; opacity: .9;" data-i18n="home.landing_sub">
                    La comunidad definitiva para
                ...
                <div class="d-flex flex-wrap justify-content-center gap-3 mt-4">
                    <a href="<?= Router::url('register') ?>"
                        ...
                        <i class="fa-solid fa-rocket me-2"></i><span data-i18n="home.start_adventure">Comienza tu
                            aventura</span>
                    </a>
                    <a href="<?= Router::url('coaster_search') ?>"
                        class="btn btn-outline-light btn-lg px-5 py-3 rounded-0 fw-bold">
                        <i class="fa-solid fa-magnifying-glass me-2"></i><span data-i18n="home.explore_coasters">Explorar
                            Coasters</span>
                    </a>
                </div>
                <!-- Mini stats -->
                <div class="d-flex flex-wrap justify-content-center gap-5 mt-5 pt-4 landing-stats-bar">
                    <div>
                        ...
                        <div class="small text-light opacity-75" data-i18n="home.landing_coasters">Montañas rusas</div>
                    </div>
                    <div class="landing-stat-sep"></div>
                    <div>
                        <div class="fw-bold fs-3 text-neon" id="landing-cnt-parks"></div>
                        <div class="small text-light opacity-75" data-i18n="home.landing_parks">Parques</div>
                    </div>
                    <!-- HIDDEN-TFG-START: "100% gratis" landing stat -->
                    <div class="landing-stat-sep hidden-tfg"></div>
                    <div class="hidden-tfg">
        ...
        <section class="py-6 position-relative">
            <div class="container py-5">
                <div class="text-center mb-5">
                    <h2 class="display-6 fw-bold text-white" data-i18n="home.all_you_need">Todo lo que necesitas</h2>
                    <p class="text-muted mt-2" data-i18n="home.built_by">Una plataforma construida por entusiastas, para
                        entusiastas</p>
                </div>
        ...
        <section class="landing-cta-section py-5">
            <div class="container py-5 text-center">
                ...
                <h2 class="display-5 fw-bold mb-3 text-white" data-i18n="home.ready_to_join">¿Listo para unirte?</h2>
                <p class="text-muted lead mb-5 mx-auto" style="max-width: 560px;" data-i18n="home.join_desc">
                ...
                <div class="d-flex flex-wrap justify-content-center gap-3">
                    <a href="<?= Router::url('register') ?>"
                        class="btn btn-success btn-lg px-5 py-3 rounded-0 fw-bold shadow">
                        <i class="fa-solid fa-rocket me-2"></i><span data-i18n="home.create_account">Crear cuenta
                            gratis</span>
                    </a>
                    <a href="<?= Router::url('login') ?>" class="btn btn-outline-light btn-lg px-5 py-3 rounded-0 fw-bold">
                        <i class="fa-solid fa-right-to-bracket me-2"></i><span data-i18n="home.already_account">Ya tengo
                            cuenta</span>
                    </a>
                </div>
                <p class="text-muted small mt-4"><span data-i18n="home.need_help">¿Necesitas ayuda?</span> <a
                        href="<?= Router::url('contact') ?>" class="text-success text-decoration-none"
                        data-i18n="home.contact_us">Contáctanos</a></p>
            </div>
        </section>
...
<script src="<?= Router::asset('web/js/shared/index.js') ?>?v=<?= time() ?>" defer></script>
<script src="<?= Router::asset('web/js/shared/recommendations.js') ?>?v=<?= time() ?>" defer></script>
<?php if ($is_admin): ?>
