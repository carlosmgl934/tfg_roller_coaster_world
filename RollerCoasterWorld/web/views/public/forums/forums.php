...
<div class="forum-chat-wrapper" data-forum-id="<?= $forumId ?>" data-user-id="<?= htmlspecialchars($userId ?? '') ?>"
    ...
    <div class="forum-chat-header" id="forum-chat-header">
        <div class="forum-header-left">
            <a href="<?= Router::url('forum_search') ?>" class="forum-back-btn" title="Volver a foros">
                <i class="fa-solid fa-arrow-left"></i>
            </a>
            <div class="forum-header-avatar" id="forum-header-avatar">
                <i class="fa-solid fa-comments"></i>
            </div>
            <div class="forum-header-info">
                <div class="forum-header-title" id="forum-header-title">Cargando...</div>
                <div class="forum-header-sub" id="forum-header-sub"></div>
            </div>
        </div>
        <div class="forum-header-right" id="forum-header-right">
            <!-- Badge privacidad + botón panel owner (se inyectan por JS) -->
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pt-3">
                ...
                <div class="mb-3 d-flex gap-2" id="invite-collab-wrapper" style="display: none !important;">
                    ...
                    <button class="btn btn-success text-white fw-bold px-3 d-flex align-items-center gap-1" id="invite-collab-btn">
...
<div class="modal fade" id="forumInfoModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="max-width: 480px;">
        <div class="modal-content" style="background: #0d1117; border: 1px solid #198754; border-radius: 0;">
            <!-- Header -->
            <div class="modal-header border-0 px-4 pt-4 pb-2" style="border-bottom: 1px solid rgba(25,135,84,0.2) !important;">
            ...
            <div class="modal-body px-4 py-3">
                ...
                <div class="mb-3">
                    <label class="text-muted text-uppercase fw-bold mb-1" style="font-size:0.7rem; letter-spacing:0.06em;">
                        <i id="forumInfoModalPrivacyIcon" class="fa-solid fa-lock me-1" style="color:#198754;"></i> <span id="forumInfoModalPrivacyText">Foro privado</span>
                    </label>
                    <div class="fw-bold text-white" id="forumInfoModalTitle" style="font-size:1.05rem; word-break:break-word;"></div>
                </div>
             ...
             <!-- Footer -->
            <div class="modal-footer border-0 px-4 pb-4 pt-2 gap-2" style="border-top:1px solid rgba(25,135,84,0.15) !important;">
                <button type="button" class="btn btn-outline-success w-100 fw-bold" data-bs-dismiss="modal">Cerrar</button>
            </div>
        </div>
    </div>
</div>
