...
<main class="container-fluid px-lg-5 my-5 min-vh-100">
    <div class="row mb-5">
        <div class="col-12 text-center">
            <h1 class="display-6 fw-bold border-bottom border-light border-opacity-50 pb-2 text-success">
                <i class="fa-solid fa-ranking-star me-2"></i> <span data-i18n="parks.tops.title">Tops de la
                    Comunidad</span>
            </h1>
            <p class="text-muted text-uppercase fw-bold mt-3" style="letter-spacing: 0.1em; font-size: 0.85rem;"
                data-i18n="parks.tops.subtitle">
            ...
            <div class="d-flex flex-wrap gap-3 align-items-center justify-content-center bg-dark p-3 border border-secondary border-opacity-25"
                ...
                <div class="flex-grow-1 position-relative" style="min-width: 200px;">
                    <input type="text" id="top-search"
                        ...
                        data-i18n-placeholder="parks.tops.search_placeholder" placeholder="Buscar usuario..."
                ...
                <select id="sort-select"
                    ...
                    style="border-width: 2px;">
                    <option value="date_desc" style="background: #212529;" selected data-i18n="parks.tops.sort_date">
                        Última modificación</option>
                    <option value="parks_desc" style="background: #212529;" data-i18n="parks.tops.sort_parks">Mayor nº
                        de parques</option>
                    <option value="alpha_asc" style="background: #212529;" data-i18n="parks.tops.sort_alpha">Orden
                        alfabético</option>
                </select>
                ...
                <div class="form-check form-switch fs-5 d-flex align-items-center ms-md-3">
                    ...
                    <label class="form-check-label ms-2 text-white" for="filterFriends"
                        style="font-size: 0.95rem; cursor: pointer;"><i
                            ...
                            data-i18n="parks.tops.friends_only">Solo amigos</span></label>
                </div>
    ...
    <div class="row g-4 justify-content-center" id="tops-grid">
        <div class="col-12 text-center py-5" id="tops-loading">
            ...
            <p class="mt-3 text-muted" data-i18n="parks.tops.loading">Cargando tops...</p>
        </div>
    </div>
</main>
