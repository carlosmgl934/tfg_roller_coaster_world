...
<main class="container-fluid px-3 px-lg-5 my-5">
      ...
      <div class="card profile-card h-100">
        ...
        <div class="card-body p-4">
          ...
          <div style="max-height: 350px; overflow-y: auto; overflow-x: hidden;" class="rcw-custom-scrollbar pe-2">
            <div class="row g-2" id="friends-list">
  ...
  <div class="modal fade" id="removeFriendModal" tabindex="-1" aria-labelledby="removeFriendModalLabel"
    aria-hidden="true">
  ...
  <div class="modal fade" id="forumInviteInfoModal" tabindex="-1" aria-labelledby="forumInviteInfoModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="max-width: 480px;">
      <div class="modal-content" style="background: #0d1117; border: 1px solid #a78bfa; border-radius: 0;">
        <!-- Header morado -->
        <div class="modal-header border-0 px-4 pt-4 pb-2"
          style="border-bottom: 1px solid rgba(167,139,250,0.2) !important;">
