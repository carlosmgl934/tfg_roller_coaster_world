    ...
    <div class="container privacy-body">
        <div class="privacy-card">
            ...
            <div class="privacy-section">
                ...
                <p>Bienvenido a <strong>Roller Coaster World</strong>. Tu privacidad es importante para nosotros. Esta
                    Política de Privacidad explica cómo recopilamos, usamos y protegemos tu información cuando visitas
                    este sitio web.</p>
            ...
            <div class="privacy-section">
                ...
                <p>Roller Coaster World recopila una cantidad mínima de datos necesarios para el funcionamiento de la
                    página:</p>
                <ul class="privacy-list">
                    <li><strong>Información proporcionada por el usuario:</strong> Datos que introduces voluntariamente
                        en los formularios de registro o contacto (como tu nombre o correo electrónico).</li>
                    <li><strong>Cookies y Almacenamiento Local:</strong> Utilizamos el almacenamiento local de tu
                        navegador para recordar tu sesión y preferencias. No utilizamos cookies de rastreo de terceros
                        para publicidad.</li>
                </ul>
            </div>
            ...
            <div class="privacy-section">
                ...
                <p><strong>No vendo, comercio ni alquilo tu información personal a terceros.</strong> Dado que este es
                    un proyecto personal sin fines de lucro comercial, tus datos se mantienen estrictamente dentro del
                    ámbito de la aplicación.</p>
            </div>

            <div class="privacy-section">
                <h2><i class="fa-solid fa-lock me-2 text-success"></i>5. Seguridad de los Datos</h2>
                <p>Implementamos medidas de seguridad básicas y razonables para proteger tu información contra acceso no
                    autorizado, alteración o destrucción. Sin embargo, ten en cuenta que ninguna transmisión por
                    Internet es 100% segura.</p>
            </div>

            <div class="privacy-section">
                <h2><i class="fa-solid fa-user-check me-2 text-success"></i>6. Tus Derechos</h2>
                <p>Tienes derecho a acceder, corregir o eliminar tu información personal en cualquier momento. Si deseas
                    que eliminemos tu cuenta o tus datos de los rankings, por favor contáctanos.</p>
            </div>
