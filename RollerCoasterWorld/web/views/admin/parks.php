            ...
            <div class="d-flex gap-2 mb-3 flex-wrap">
                <div class="flex-grow-1 position-relative">
                    <input type="text" id="admin-park-search"
                        ...
                        placeholder="Buscar parque" style="border-width:2px;">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="add-park-name" class="form-control form-control-lg rounded-0" placeholder="Ej: Cedar Point"
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="position-relative">
                            <div class="input-group">
                                ...
                                <input type="text" id="add-park-country" autocomplete="off" class="form-control rounded-0" placeholder="Escribe para buscar..."
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="add-park-location" class="form-control rounded-0" placeholder="Ej: Sandusky, Ohio"
                                style="border-width:2px;border-color:#198754;background:#0d1117;color:#e6edf3;height:46px;border-left:none;box-shadow:none;">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" id="add-park-year" class="form-control rounded-0" placeholder="Ej: 1964" min="1800" max="2035"
                                style="border-width:2px;border-color:#198754;background:#0d1117;color:#e6edf3;height:46px;border-left:none;box-shadow:none;">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="input-group">
                            <span class="input-group-text rounded-0 border-success" style="background:#0d1117;border-width:2px;color:#198754;border-right:none;"><i class="fa-solid fa-globe"></i></span>
                            <input type="url" id="add-park-website" class="form-control rounded-0" placeholder="https://www.cedarpoint.com"
                                style="border-width:2px;border-color:#198754;background:#0d1117;color:#e6edf3;height:46px;border-left:none;box-shadow:none;">
                        </div>
                    </div>

                    <div class="col-12 col-md-6">
                        <label class="form-label fw-semibold small text-uppercase text-muted mb-2">Precio entrada (€)</label>
                        <div class="input-group">
                            <span class="input-group-text rounded-0 border-success" style="background:#0d1117;border-width:2px;color:#198754;border-right:none;"><i class="fa-solid fa-euro-sign"></i></span>
                            <input type="number" id="add-park-price" class="form-control rounded-0" placeholder="Ej: 49.99" min="0" step="0.01"
                                style="border-width:2px;border-color:#198754;background:#0d1117;color:#e6edf3;height:46px;border-left:none;box-shadow:none;">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div id="add-park-dropzone" onclick="document.getElementById('add-park-image').click()"
                    ...
                    <div class="col-12">
                        ...
                        <p class="text-muted small mb-2">Coasters sin parque asignado ("Desconocido") que puedes asignar a este parque.</p>
                        <div style="overflow:hidden;">
                            <input type="text" id="add-park-coasters-search" class="form-control rounded-0" placeholder="Buscar coaster..."
            ...
            <div class="modal-body p-5" style="background:#161b22;">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        <label class="form-label fw-semibold small text-uppercase text-muted mb-2">Nombre del parque <span class="text-danger">*</span></label>
                        <div class="input-group">
                            <span class="input-group-text rounded-0 border-primary" style="background:#0d1117;border-width:2px;color:#0d6efd;border-right:none;"><i class="fa-brands fa-fort-awesome"></i></span>
                            <input type="text" id="edit-park-name" class="form-control form-control-lg rounded-0" placeholder="Ej: Cedar Point"
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="position-relative">
                            <div class="input-group">
                                <span class="input-group-text rounded-0 border-primary" style="background:#0d1117;border-width:2px;color:#0d6efd;border-right:none;"><i class="fa-solid fa-earth-americas"></i></span>
                                <input type="text" id="edit-park-country" autocomplete="off" class="form-control rounded-0" placeholder="Escribe para buscar..."
                    ...
                    <div class="col-12 col-md-6">
                        <label class="form-label fw-semibold small text-uppercase text-muted mb-2">Localización <span class="text-danger">*</span></label>
                        <div class="input-group">
                            <span class="input-group-text rounded-0 border-primary" style="background:#0d1117;border-width:2px;color:#0d6efd;border-right:none;"><i class="fa-solid fa-location-dot"></i></span>
                            <input type="text" id="edit-park-location" class="form-control rounded-0" placeholder="Ej: Sandusky, Ohio"
                                style="border-width:2px;border-color:#0d6efd;background:#0d1117;color:#e6edf3;height:46px;border-left:none;box-shadow:none;">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            <label class="form-label fw-semibold small text-uppercase text-muted mb-0">Año de apertura</label>
                            <div class="form-check form-switch mb-0">
                                <input class="form-check-input admin-toggle" type="checkbox" role="switch" id="unknown-edit-park-year"
                                ...
                                <label class="form-check-label text-muted small" for="unknown-edit-park-year">Desconocido</label>
                            </div>
                        </div>
                        <div class="input-group">
                            <span class="input-group-text rounded-0 border-primary" style="background:#0d1117;border-width:2px;color:#0d6efd;border-right:none;"><i class="fa-regular fa-calendar-days"></i></span>
                            <input type="number" id="edit-park-year" class="form-control rounded-0" placeholder="Ej: 1964" min="1800" max="2035"
                                style="border-width:2px;border-color:#0d6efd;background:#0d1117;color:#e6edf3;height:46px;border-left:none;box-shadow:none;">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <label class="form-label fw-semibold small text-uppercase text-muted mb-2">Web oficial</label>
                        <div class="input-group">
                            <span class="input-group-text rounded-0 border-primary" style="background:#0d1117;border-width:2px;color:#0d6efd;border-right:none;"><i class="fa-solid fa-globe"></i></span>
                            <input type="url" id="edit-park-website" class="form-control rounded-0" placeholder="https://www.cedarpoint.com"
                                style="border-width:2px;border-color:#0d6efd;background:#0d1117;color:#e6edf3;height:46px;border-left:none;box-shadow:none;">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <label class="form-label fw-semibold small text-uppercase text-muted mb-2">Precio entrada (€)</label>
                        <div class="input-group">
                            <span class="input-group-text rounded-0 border-primary" style="background:#0d1117;border-width:2px;color:#0d6efd;border-right:none;"><i class="fa-solid fa-euro-sign"></i></span>
                            <input type="number" id="edit-park-price" class="form-control rounded-0" placeholder="Ej: 49.99" min="0" step="0.01"
                                style="border-width:2px;border-color:#0d6efd;background:#0d1117;color:#e6edf3;height:46px;border-left:none;box-shadow:none;">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <label class="form-label fw-semibold small text-uppercase text-muted mb-2">Imagen del parque</label>
                        <div id="edit-park-dropzone" onclick="document.getElementById('edit-park-image').click()"
                            style="border:2px dashed #0d6efd;background:rgba(13,110,253,0.05);cursor:pointer;
                                   padding:1rem;display:flex;flex-direction:column;align-items:center;text-align:center;gap:0.5rem;
                                   transition:all .2s ease;height:46px;justify-content:center;overflow:hidden;">
                            <div class="d-flex align-items-center gap-2">
                                <i class="fa-solid fa-cloud-arrow-up text-primary"></i>
                                <span class="text-white small fw-bold" id="edit-park-dropzone-text">Cambiar imagen</span>
                            </div>
                        </div>
                        <input type="file" id="edit-park-image" accept="image/*" class="d-none">
                        <div id="edit-park-preview-container" class="mt-2">
                            <img id="edit-park-preview" src="" class="img-thumbnail bg-dark border-secondary" style="max-height:100px;display:none;">
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <label class="form-label fw-semibold small text-uppercase text-muted mb-2">
                            ...
                            <span class="badge bg-secondary fw-normal ms-2" id="edit-park-coasters-badge">0 asignadas</span>
                        </label>
                        <p class="text-muted small mb-2">Las marcadas están asignadas a este parque. Desmarca para moverlas a "Desconocido". También puedes añadir coasters sin parque asignado.</p>
                        <div style="overflow:hidden;">
                            <input type="text" id="edit-park-coasters-search" class="form-control rounded-0" placeholder="Buscar coaster..."
                                style="border-width:2px;border-color:#30363d;background:#0d1117;color:#e6edf3;box-shadow:none;outline:0;">
                        </div>
                        <div style="height:0.5rem;"></div>
                ...
                <div id="edit-park-messages" class="w-100 mt-4 d-none">
                    <div class="alert alert-danger rounded-0 border-0 mb-0 d-none" id="edit-park-error"><i class="fa-solid fa-circle-exclamation me-2"></i><span></span></div>
                    <div class="alert alert-success rounded-0 border-0 mb-0 d-none" id="edit-park-success"><i class="fa-solid fa-circle-check me-2"></i><span></span></div>
                </div>
            </div>
            <div class="modal-footer border-0 px-5 pb-4 pt-2" style="background:#161b22;">
                <button type="button" class="btn btn-outline-secondary rounded-0 px-4" data-bs-dismiss="modal">Cancelar</button>
...
<!-- ===== MODAL DUPLICAR ===== -->
<div class="modal fade" id="modal-duplicate-park" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-0 border-0 shadow">
            <div class="modal-header bg-warning text-dark">
                <h5 class="modal-title"><i class="fa-solid fa-copy me-2"></i>Duplicar parque</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <p class="mb-1">Se creará una copia de:</p>
                <p class="fw-bold text-warning mb-0" id="duplicate-park-name">—</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-outline-secondary rounded-0" data-bs-dismiss="modal">Cancelar</button>
                <button type="button" class="btn btn-warning rounded-0 fw-bold text-dark" id="confirm-duplicate-park" data-id="">
