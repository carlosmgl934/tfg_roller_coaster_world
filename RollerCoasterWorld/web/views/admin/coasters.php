    ...
    <div class="row pt-4 mb-4">
        <div class="col-12 d-flex justify-content-between align-items-center border-bottom pb-3">
            ...
            <div class="d-flex gap-2">
                <button type="button" class="btn btn-danger fw-bold rounded-0 shadow-sm px-4 d-none"
                    id="btn-bulk-delete">
            ...
            <div class="card shadow-sm border-0 sticky-top rounded-0" style="top: 90px; z-index: 1;">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 position-relative">
                        <input type="text" id="filter-park-search" class="form-control shadow-sm rounded-0"
                            placeholder="Buscar parque...">
                        <input type="hidden" id="filter-park" value="">
                        <div id="filter-park-results" class="autocomplete-dropdown d-none"
                            style="position: absolute; top: 100%; left: 0; right: 0; z-index: 1000; background: #161b22; border: 1px solid #30363d; max-height: 200px; overflow-y: auto;">
                        </div>
                    </div>
            ...
            <div class="d-flex gap-2 mb-3 flex-wrap">
                <div class="flex-grow-1 position-relative">
                    <input type="text" id="admin-coaster-search"
                        class="form-control shadow-sm pe-5 border-success rounded-0" placeholder="Buscar montaña rusa"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-0 border-0 shadow">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger rounded-0 fw-bold" id="confirm-delete-coaster" data-id="">
...
<div class="modal fade" id="modal-bulk-delete-coaster" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-0 border-0 shadow">
            ...
            <div class="modal-body">
                <p class="mb-1">¿Estás seguro de que quieres eliminar las <span class="fw-bold text-danger"
                        id="bulk-delete-coaster-count">0</span> montañas rusas seleccionadas?</p>
                <p class="text-muted small mt-2"><i class="fa-solid fa-circle-info me-1"></i>Esta acción es irreversible
                    y borrará permanentemente todo su historial.</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-outline-secondary rounded-0" data-bs-dismiss="modal">
                    Cancelar
                </button>
                <button type="button" class="btn btn-danger rounded-0 fw-bold" id="confirm-bulk-delete-coaster">
...
<div class="modal fade" id="modal-add-coaster" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" style="max-width: 1400px;">
        <form id="add-coaster-form" class="modal-content rounded-0 border-0 shadow-lg" style="background:#161b22;">
            ...
            <div class="modal-body p-5" style="background:#161b22;">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-12 col-lg-7 pe-lg-4">
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                <label class="form-label fw-semibold small text-uppercase text-muted mb-2">Nombre de
                                    la atracción <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    ...
                                    <input type="text" id="add-coaster-name"
                                        class="form-control form-control-lg rounded-0" placeholder="Ej: Steel Vengeance"
                                        style="border-width:2px;border-color:#198754;background:#0d1117;color:#e6edf3; border-left:none; box-shadow:none;">
                                </div>
                            </div>

                            <div class="col-12">
                                <label class="form-label fw-semibold small text-uppercase text-muted mb-2">Fabricante
                                ...
                                <div class="position-relative">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="add-coaster-manufacturer" autocomplete="off"
                                            data-ac="manufacturer" class="form-control rounded-0"
                                        ...
                                        <button type="button" id="btn-new-manufacturer"
                                            class="btn btn-outline-success rounded-0 px-3 text-nowrap fw-semibold"
                                            style="border-width:2px;">
                            ...
                            <div class="col-12">
                                <label class="form-label fw-semibold small text-uppercase text-muted mb-2">Modelo
                                    <span class="text-danger">*</span></label>
                                <div class="position-relative">
                                    <div class="input-group">
                                        <span class="input-group-text rounded-0 border-success"
                            ...
                            <div class="col-12">
                                <label class="form-label fw-semibold small text-uppercase text-muted mb-2">Parque
                                    <span class="text-danger">*</span></label>
                                <div class="position-relative">
                                    <div class="input-group">
                                        <span class="input-group-text rounded-0 border-success"
                            ...
                            <div class="col-12">
                                <label class="form-label fw-semibold small text-uppercase text-muted mb-2">País
                                    <span class="text-danger">*</span></label>
                                <div class="position-relative">
                                    <div class="input-group">
                                        <span class="input-group-text rounded-0 border-success"
                            ...
                            <div class="col-12 col-md-6">
                                <label class="form-label fw-semibold small text-uppercase text-muted mb-2">Estado
                            ...
                            <div class="col-12 col-md-6">
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <label class="form-label fw-semibold small text-uppercase text-muted mb-0">Año
                                        de apertura</label>
                                    <div class="form-check form-switch mb-0">
                                        <input class="form-check-input admin-toggle" type="checkbox" role="switch"
                                            id="unknown-year"
                                            onchange="document.getElementById('add-coaster-year').disabled = this.checked; if(this.checked) document.getElementById('add-coaster-year').value='';">
                                        <label class="form-check-label text-muted small"
                                            for="unknown-year">Desconocido</label>
                                    </div>
                                </div>
                                <div class="input-group">
                                    <span class="input-group-text rounded-0 border-success"
                            ...
                            <div class="col-12 mt-5">
                                <div class="d-flex align-items-center gap-3 mb-1">
                                    <div
                                        style="height:2px;flex:1;background:linear-gradient(90deg, transparent, #198754);">
                                    </div>
                                    <span class="text-success fw-bold text-uppercase small"
                                        style="letter-spacing: 1px;"><i
                                            class="fa-solid fa-ruler-combined me-2"></i>Estadísticas técnicas</span>
                                    <div
                                        style="height:2px;flex:1;background:linear-gradient(270deg, transparent, #198754);">
                                    </div>
                                </div>
                                <p class="text-muted text-center small mb-2">Introduce las estadísticas numéricas de
                                    la atracción</p>
                            </div>

                            <div class="col-6 col-md-3">
                                <div class="p-3 text-center transition-all"
                                    style="background:#0d1117; border: 2px solid #198754;">
                                    <i class="fa-solid fa-arrow-up-right-dots fs-4 text-muted mb-2"></i>
                                    <label
                                        class="form-label fw-semibold small text-uppercase text-muted d-block mb-2">Altura</label>
                                    <div class="input-group input-group-sm mb-2">
                                        <input type="number" id="add-coaster-height"
                                            class="form-control rounded-0 text-center no-spinners" placeholder="0"
                                            min="0" step="0.01" autocomplete="off"
                                            style="background:#161b22; color:#e6edf3; border:1px solid #30363d; box-shadow:none;">
                                        <span class="input-group-text rounded-0"
                                            style="background:#30363d; border:1px solid #30363d; color:#e6edf3;">m</span>
                                    </div>
                                    <div
                                        class="form-check form-switch d-flex justify-content-center align-items-center gap-2">
                                        <input class="form-check-input admin-toggle" type="checkbox" role="switch"
                                            id="unknown-height"
                                            onchange="document.getElementById('add-coaster-height').disabled = this.checked; if(this.checked) document.getElementById('add-coaster-height').value='';">
                                        <label class="form-check-label text-muted" style="font-size:0.72rem;"
                                            for="unknown-height">Desconocido</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-6 col-md-3">
                                <div class="p-3 text-center" style="background:#0d1117; border: 2px solid #198754;">
                                    ...
                                    <label
                                        class="form-label fw-semibold small text-uppercase text-muted d-block mb-2">Velocidad</label>
                                    <div class="input-group input-group-sm mb-2">
                                        <input type="number" id="add-coaster-speed"
                                            class="form-control rounded-0 text-center no-spinners" placeholder="0"
                                            min="0" step="0.01" autocomplete="off"
                                            style="background:#161b22; color:#e6edf3; border:1px solid #30363d; box-shadow:none;">
                                        <span class="input-group-text rounded-0"
                                            style="background:#30363d; border:1px solid #30363d; color:#e6edf3;">km/h</span>
                                    </div>
                                    <div
                                        class="form-check form-switch d-flex justify-content-center align-items-center gap-2">
                                        <input class="form-check-input admin-toggle" type="checkbox" role="switch"
                                            id="unknown-speed"
                                            onchange="document.getElementById('add-coaster-speed').disabled = this.checked; if(this.checked) document.getElementById('add-coaster-speed').value='';">
                                        <label class="form-check-label text-muted" style="font-size:0.72rem;"
                                            for="unknown-speed">Desconocido</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-6 col-md-3">
                                <div class="p-3 text-center" style="background:#0d1117; border: 2px solid #198754;">
                                    ...
                                    <label
                                        class="form-label fw-semibold small text-uppercase text-muted d-block mb-2">Longitud</label>
                                    <div class="input-group input-group-sm mb-2">
                                        <input type="number" id="add-coaster-length"
                                            class="form-control rounded-0 text-center no-spinners" placeholder="0"
                                            min="0" step="0.01" autocomplete="off"
                                            style="background:#161b22; color:#e6edf3; border:1px solid #30363d; box-shadow:none;">
                                        <span class="input-group-text rounded-0"
                                    ...
                                    <div
                                        ...
                                        <input class="form-check-input admin-toggle" type="checkbox" role="switch"
                                            id="unknown-length"
                                            onchange="document.getElementById('add-coaster-length').disabled = this.checked; if(this.checked) document.getElementById('add-coaster-length').value='';">
                                        <label class="form-check-label text-muted" style="font-size:0.72rem;"
                                            for="unknown-length">Desconocido</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-6 col-md-3">
                                <div class="p-3 text-center" style="background:#0d1117; border: 2px solid #198754;">
                                    ...
                                    <label
                                        class="form-label fw-semibold small text-uppercase text-muted d-block mb-2">Inversiones</label>
                                    <input type="number" id="add-coaster-inversions"
                                        class="form-control form-control-sm rounded-0 text-center no-spinners w-100 mx-auto mb-2"
                                    ...
                                    <div
                                        class="form-check form-switch d-flex justify-content-center align-items-center gap-2">
                                        <input class="form-check-input admin-toggle" type="checkbox" role="switch"
                                            id="unknown-inversions"
                                            onchange="document.getElementById('add-coaster-inversions').disabled = this.checked; if(this.checked) document.getElementById('add-coaster-inversions').value='';">
                                        <label class="form-check-label text-muted" style="font-size:0.72rem;"
                                            for="unknown-inversions">Desconocido</label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-lg-5 d-flex flex-column"
                        ...
                        <div class="d-lg-flex ps-lg-4 flex-column h-100 mt-4 mt-lg-0">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <label class="form-label fw-bold text-uppercase text-white mb-0"
                                    style="letter-spacing: 0.5px;">Portada (Imagen Principal)</label>
                            </div>

                            <div id="add-coaster-dropzone"
                                onclick="document.getElementById('add-coaster-image').click()" style="border:2px dashed #198754;background:rgba(25,135,84,0.05);cursor:pointer;
                                ...
                                <div>
                                    <div class="fw-bold text-white mb-1" style="font-size:1.1rem;">Haz clic para
                                        buscar</div>
                            ...
                            <div id="add-coaster-preview" class="mt-4 flex-grow-1 position-relative" style="min-height:280px;background:#0d1117;
                                       border:1px solid rgba(255,255,255,0.08);
                                       display:flex;align-items:center;justify-content:center;
                                       overflow:hidden;">
                                <div class="text-center text-muted">
                                    <i class="fa-regular fa-image fa-3x d-block mb-3" style="opacity:0.2;"></i>
                                    <span style="font-size:0.85rem; letter-spacing:1px; text-transform:uppercase;">Vista
                                        previa</span>
                                </div>
                            </div>
                            ...
                            <div class="mt-3 d-flex justify-content-center pt-2">
                                <span class="text-muted" style="font-size:0.75rem;"><i
                                        class="fa-solid fa-circle-info text-success me-1"></i> Optimiza los archivos
                                    multimedia antes de subir para no afectar al rendimiento</span>
                            </div>
                ...
                <div id="add-coaster-messages" class="w-100 mt-4 d-none">
                    <div class="alert alert-danger rounded-0 border-0 mb-0 d-none" id="add-coaster-error"><i
                            class="fa-solid fa-circle-exclamation me-2"></i><span></span></div>
                    <div class="alert alert-success rounded-0 border-0 mb-0 d-none" id="add-coaster-success"><i
...
<div class="modal fade" id="modal-edit-coaster" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" style="max-width: 1400px;">
        <form id="edit-coaster-form" class="modal-content rounded-0 border-0 shadow-lg" style="background:#161b22;">
            <input type="hidden" id="edit-coaster-id">

            <div class="modal-header text-white border-0 py-3 px-4" style="background:#10b981;">
                <div class="d-flex align-items-center gap-3">
                    <div class="d-flex align-items-center justify-content-center bg-white bg-opacity-25 rounded-1 p-2"
                        style="width: 40px; height: 40px;">
                        <i class="fa-solid fa-pen-to-square fs-5"></i>
                    </div>
                    <div>
                        <h5 class="modal-title fw-bold mb-0" style="letter-spacing: 0.5px;">Actualizar Datos de la
                            Atracción</h5>
                        <div class="badge mt-1 rounded-pill"
                            style="background-color: rgba(0,0,0,0.25); color: #d1fae5; font-size: 0.72rem; font-weight:700; letter-spacing: 1px; padding: 0.4em 0.8em; border: 1px solid rgba(255,255,255,0.2);">
                            MODO DE EDICIÓN ACTIVO</div>
                    </div>
                </div>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
            </div>
            ...
            <div class="modal-body p-5" style="background:#161b22;">
                    ...
                    <div class="col-12 col-lg-7 pe-lg-4">
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text rounded-0"
                                        style="background:#0d1117; border:2px solid #10b981; color:#10b981; border-right:none;"><i
                                            class="fa-solid fa-ticket-simple"></i></span>
                                    <input type="text" id="edit-coaster-name"
                                        class="form-control form-control-lg rounded-0" placeholder="Ej: Steel Vengeance"
                                ...
                                <div class="position-relative">
                                    <div class="input-group">
                                        <span class="input-group-text rounded-0"
                                            style="background:#0d1117; border:2px solid #10b981; color:#10b981; border-right:none;"><i
                                                class="fa-solid fa-industry"></i></span>
                                        <input type="text" id="edit-coaster-manufacturer" autocomplete="off"
                                            data-ac="manufacturer" class="form-control rounded-0"
                                            placeholder="Escribe para buscar..."
                                        ...
                                        <button type="button" id="btn-edit-new-manufacturer"
                                            class="btn rounded-0 px-3 text-nowrap fw-semibold d-none"
                                ...
                                <div class="position-relative">
                                    <div class="input-group">
                                        <span class="input-group-text rounded-0"
                                            style="background:#0d1117; border:2px solid #10b981; color:#10b981; border-right:none;"><i
                                                class="fa-solid fa-earth-americas"></i></span>
                                        <input type="text" id="edit-coaster-country" autocomplete="off"
                                            data-ac="country" class="form-control rounded-0"
                                            placeholder="Escribe para buscar..."
                                            style="border-width:2px;border-color:#10b981;background:#0d1117;color:#e6edf3;height:46px; border-left:none; box-shadow:none;">
                                    </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    ...
                                    <div class="form-check form-switch mb-0">
                                        <input class="form-check-input admin-toggle" type="checkbox" role="switch"
                                            id="edit-unknown-year"
                                            onchange="let el = document.getElementById('edit-coaster-year'); el.disabled = this.checked; el.placeholder = this.checked ? '' : 'Ej: 2003'; if(this.checked) el.value='';">
                                        <label class="form-check-label text-muted small"
                                            for="edit-unknown-year">Desconocido</label>
                                    </div>
                                </div>
                                <div class="input-group">
                                    <span class="input-group-text rounded-0"
                            ...
                            <div class="col-12 mt-5">
                                <div class="d-flex align-items-center gap-3 mb-1">
                                    <div
                                        style="height:2px;flex:1;background:linear-gradient(90deg, transparent, #10b981);">
                                    </div>
                                    <span class="fw-bold text-uppercase small"
                                        style="color:#10b981; letter-spacing: 1px;"><i
                                            class="fa-solid fa-ruler-combined me-2"></i>Estadísticas técnicas</span>
                                    <div
                                        style="height:2px;flex:1;background:linear-gradient(270deg, transparent, #10b981);">
                                    </div>
                                </div>
                                <p class="text-muted text-center small mb-2">Modifica las estadísticas numéricas de
                                    la atracción</p>
                            </div>
                            ...
                            <div class="col-6 col-md-3">
                                <div class="p-3 text-center transition-all"
                                    ...
                                    <label
                                        class="form-label fw-semibold small text-uppercase text-muted d-block mb-2">Altura</label>
                                    <div class="input-group input-group-sm mb-2">
                                        <input type="number" id="edit-coaster-height"
                                            class="form-control rounded-0 text-center no-spinners" placeholder="0"
                                            min="0" step="0.01" autocomplete="off"
                                            style="background:#161b22; color:#e6edf3; border:1px solid #30363d; box-shadow:none;">
                                        <span class="input-group-text rounded-0"
                                    ...
                                    <div
                                        class="form-check form-switch d-flex justify-content-center align-items-center gap-2">
                                        <input class="form-check-input admin-toggle" type="checkbox" role="switch"
                                            id="edit-unknown-height"
                                            onchange="let el = document.getElementById('edit-coaster-height'); el.disabled = this.checked; el.placeholder = this.checked ? '' : '0'; if(this.checked) el.value='';">
                                        <label class="form-check-label text-muted" style="font-size:0.72rem;"
                                            for="edit-unknown-height">Desconocido</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-6 col-md-3">
                                <div class="p-3 text-center" style="background:#0d1117; border: 2px solid #10b981;">
                                    ...
                                    <label
                                        class="form-label fw-semibold small text-uppercase text-muted d-block mb-2">Velocidad</label>
                                    <div class="input-group input-group-sm mb-2">
                                        <input type="number" id="edit-coaster-speed"
                                            class="form-control rounded-0 text-center no-spinners" placeholder="0"
                                            min="0" step="0.01" autocomplete="off"
                                            style="background:#161b22; color:#e6edf3; border:1px solid #30363d; box-shadow:none;">
                                        <span class="input-group-text rounded-0"
                                    ...
                                    <div
                                        class="form-check form-switch d-flex justify-content-center align-items-center gap-2">
                                        <input class="form-check-input admin-toggle" type="checkbox" role="switch"
                                            id="edit-unknown-speed"
                                            onchange="let el = document.getElementById('edit-coaster-speed'); el.disabled = this.checked; el.placeholder = this.checked ? '' : '0'; if(this.checked) el.value='';">
                                        <label class="form-check-label text-muted" style="font-size:0.72rem;"
                                            for="edit-unknown-speed">Desconocido</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-6 col-md-3">
                                <div class="p-3 text-center" style="background:#0d1117; border: 2px solid #10b981;">
                                    ...
                                    <label
                                        class="form-label fw-semibold small text-uppercase text-muted d-block mb-2">Longitud</label>
                                    <div class="input-group input-group-sm mb-2">
                                        <input type="number" id="edit-coaster-length"
                                            class="form-control rounded-0 text-center no-spinners" placeholder="0"
                                            min="0" step="0.01" autocomplete="off"
                                            style="background:#161b22; color:#e6edf3; border:1px solid #30363d; box-shadow:none;">
                                        <span class="input-group-text rounded-0"
                                    ...
                                    <div
                                        class="form-check form-switch d-flex justify-content-center align-items-center gap-2">
                                        <input class="form-check-input admin-toggle" type="checkbox" role="switch"
                                            id="edit-unknown-length"
                                            onchange="let el = document.getElementById('edit-coaster-length'); el.disabled = this.checked; el.placeholder = this.checked ? '' : '0'; if(this.checked) el.value='';">
                                        <label class="form-check-label text-muted" style="font-size:0.72rem;"
                                            for="edit-unknown-length">Desconocido</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-6 col-md-3">
                                <div class="p-3 text-center" style="background:#0d1117; border: 2px solid #10b981;">
                                    ...
                                    <label
                                        class="form-label fw-semibold small text-uppercase text-muted d-block mb-2">Inversiones</label>
                                    <input type="number" id="edit-coaster-inversions"
                                        class="form-control form-control-sm rounded-0 text-center no-spinners w-100 mx-auto mb-2"
                                        placeholder="0" min="0" autocomplete="off"
                                        style="background:#161b22; color:#e6edf3; border:1px solid #30363d; box-shadow:none; max-width:80px;">
                                    <div
                                        class="form-check form-switch d-flex justify-content-center align-items-center gap-2">
                                        <input class="form-check-input admin-toggle" type="checkbox" role="switch"
                                            id="edit-unknown-inversions"
                                            onchange="let el = document.getElementById('edit-coaster-inversions'); el.disabled = this.checked; el.placeholder = this.checked ? '' : '0'; if(this.checked) el.value='';">
                                        <label class="form-check-label text-muted" style="font-size:0.72rem;"
                                            for="edit-unknown-inversions">Desconocido</label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-lg-5 d-flex flex-column"
                        ...
                        <div class="d-lg-flex ps-lg-4 flex-column h-100 mt-4 mt-lg-0">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <label class="form-label fw-bolder text-uppercase text-white mb-0"
                                    style="letter-spacing: 1px; font-size:1.1rem;">ACTUALIZAR PORTADA</label>
                            </div>

                            <div id="edit-coaster-dropzone"
                                onclick="document.getElementById('edit-coaster-image').click()" style="border:2px dashed #10b981;background:rgba(16,185,129,0.05);cursor:pointer;
                                       padding:2rem 1.5rem;display:flex;flex-direction:column;align-items:center;text-align:center;gap:1rem;
                                       transition:all .2s ease;">
                                <i class="fa-solid fa-cloud-arrow-up fs-1 mb-1" style="color:#10b981;"></i>
                                <div>
                                    <div class="fw-bold text-white mb-1" style="font-size:1.1rem;">Haz clic para
                                        buscar nueva imagen</div>
                                    <div class="text-muted small">o arrastra el archivo aquí</div>
                                </div>
                                <div class="badge border text-muted mt-2 fw-normal px-3 py-2"
                                    style="background:#0d1117; border-color:#30363d;">
                                    JPG, PNG, WebP, MP4, WebM <br> Recom.: 1280×720px (16:9)
                                </div>
                            </div>
                            <input type="file" id="edit-coaster-image" accept="image/*,video/*" class="d-none">

                            <div id="edit-coaster-preview" class="mt-4 flex-grow-1 position-relative" style="min-height:280px;background:#0d1117;
                                       border:1px solid rgba(255,255,255,0.08);
                                       display:flex;align-items:center;justify-content:center;
                                       overflow:hidden;">
                                <div class="text-center text-muted">
                                    <i class="fa-regular fa-image fa-3x d-block mb-3" style="opacity:0.2;"></i>
                                    <span style="font-size:0.85rem; letter-spacing:1px; text-transform:uppercase;">Vista
                                        previa original / nueva</span>
                                </div>
                            </div>

                            <div class="mt-3 d-flex justify-content-center pt-2">
                                <span class="text-muted" style="font-size:0.75rem;"><i
                                        class="fa-solid fa-circle-info me-1" style="color:#10b981;"></i> Optimiza
                                    los archivos multimedia antes de subir para no afectar al rendimiento</span>
                            </div>
                ...
                <div id="edit-coaster-messages" class="w-100 mt-4 d-none">
                    <div class="alert alert-danger rounded-0 border-0 mb-0 d-none" id="edit-coaster-error"><i
                            class="fa-solid fa-circle-exclamation me-2"></i><span></span></div>
                    <div class="alert rounded-0 border-0 mb-0 d-none" id="edit-coaster-success"
                        style="background-color: rgba(16,185,129,0.1); color: #10b981;"><i
                            class="fa-solid fa-circle-check me-2"></i><span></span></div>
                </div>
            </div>
            ...
            <div class="modal-footer border-0 px-5 pb-4 pt-2" style="background:#161b22;">
                ...
                <button type="button" class="btn rounded-0 fw-bold px-5" id="confirm-edit-coaster"
