document.addEventListener("DOMContentLoaded", () => {
    ...
    emailInput.addEventListener("blur", () => {
        ...
        if (!emailRegex.test(emailInput.value)) {
            emailError.textContent = "Por favor, introduce un correo electrónico válido. Ejemplo: nombre@dominio.com";
    ...
    messageInput.addEventListener("blur", () => {
        ...
        if(messageInput.value.length < 20){
            messageError.textContent = "Por favor, introduce un mensaje con al menos 20 caracteres";
    ...
    submitBtn.addEventListener("click", async (e) => {
        e.preventDefault();
        const frecuencySelect = document.querySelector("input[name=frecuency]:checked");

        //Validación de campos vacíos
        if (nameInput.value.trim() === "" || emailInput.value.trim() === "" || reasonSelect.value === "" ||
