...
$routes = [
    ...
    'coaster_search' => $base_url . '/web/views/public/coaster_search.php',
    'coaster_reviews' => $base_url . '/web/views/public/coaster_reviews.php',
    'coaster_tops' => $base_url . '/web/views/public/coaster_tops.php',
